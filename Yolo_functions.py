...
import time
import cv2
from Classifier_model import CNN
...
def predictImage(INPUT_FILE, model=None, show=False, returnImg=False):
    ...
    if os.path.isfile(WEIGHTS_FILE) == False:
        url = 'https://drive.google.com/file/d/1_UcHkZqF-y58NNyNlR7AnZAY6snKAutW/view?usp=sharing'
    ...
    print("[INFO] MODEL took {:.6f} seconds".format(end - allstart))
    if show:
